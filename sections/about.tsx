import {Box, Container, Section, StyledImage, SubTextLight, Title} from "./about-elements";
            ...
            <Container>
                <Box>
                    ...
                    <SubTextLight>
                        ...
                        date with the latest technical trends. In my free time, I enjoy reading, listening to music or
                    ...
                    <Stack direction="row" spacing={2} padding={3}>
                        ...
                        <Chip component="a" href="https://dart.dev/" target="_blank" size="medium" label={<SubTextLight>
                            Dart
                        </SubTextLight>}
                        ...
                        <Chip component="a" href="https://developer.apple.com/swift/" target="_blank" size="medium"
                              label={<SubTextLight>
                                  Swift
                              </SubTextLight>} avatar={<Avatar src="/swift.svg"/>} clickable/>
                    </Stack>
                    <Stack direction="row" spacing={2} paddingX={5}>
                        <Chip component="a" href="https://nextjs.org/" target="_blank" size="medium"
                              label={<SubTextLight>
                                  NextJS
                              </SubTextLight>}
                              avatar={<Avatar src="/next-js.svg"/>} clickable/>
                        <Chip component="a" href="https://reactjs.org/" target="_blank" size="medium"
                              label={<SubTextLight>
                                  React
                              </SubTextLight>}
                        ...
                        <Chip component="a" href="https://www.typescriptlang.org/" target="_blank" size="medium"
                              label={<SubTextLight>
                                  TypeScript
                              </SubTextLight>} avatar={<Avatar src="/typescript.svg"/>} clickable/>
                    </Stack>
                    <Stack direction="row" spacing={2} paddingX={5} paddingTop={3} paddingBottom={3}>
                        <Chip component="a" href="https://developer.apple.com/xcode/swiftui/" target="_blank"
                              size="medium" label={<SubTextLight>
                            SwiftUI
                        </SubTextLight>} avatar={<Avatar src="/swiftui.svg"/>} clickable/>
                        <Chip component="a" href="https://developer.mozilla.org/en-US/docs/Web/JavaScript"
                              target="_blank" size="medium" label={<SubTextLight>
                            JavaScript
                        </SubTextLight>} avatar={<Avatar src="/javascript.svg"/>}
                              clickable/>
                    </Stack>
                </Box>
                <Box>
                    <StyledImage src="/memoji.jpeg" alt="Profile image" width={300} height={300}/>
                </Box>
            </Container>
        </Section>
    )
